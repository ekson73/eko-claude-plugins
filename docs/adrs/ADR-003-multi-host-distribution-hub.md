...
- **Scope**: This repo only (`eko-claude-plugins` → future `eko-pack-index`). **Not** multi-agent-os content.
...
6. Rename to **`eko-pack-index`** (Anima) is planned (ADR-004); not blocking P0–P1 structure.
